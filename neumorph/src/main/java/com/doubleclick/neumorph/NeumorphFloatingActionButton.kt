...
import com.doubleclick.neumorph.internal.util.NeumorphResources
...
class NeumorphFloatingActionButton @JvmOverloads constructor(
    ...
    init {
        ...
        val lightSource = a.getInt(R.styleable.NeumorphFloatingActionButton_neumorph_lightSource,
            LightSource.DEFAULT
        )
        val shapeType = a.getInt(R.styleable.NeumorphFloatingActionButton_neumorph_shapeType,
            ShapeType.DEFAULT
        )
